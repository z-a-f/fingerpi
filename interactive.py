...
import sys # Need it to catch ALL exceptions
...
menu_data = {
    ...
    'options':[
        { 'title': "Initialize", 'type': COMMAND, 'command': 'fingerprint = fp.FingerPi()' },
        { 'title': "Open", 'type': COMMAND, 'command': 'fingerprint.Open()' },
...
# Main program
curses.wrapper(processmenu,menu_data)
